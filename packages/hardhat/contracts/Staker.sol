...
contract Staker {
    ...
    uint256 public constant RewardPercentage = 1;
...
//        uint256 indBalanceRewards = individualBalance + ((block.timestamp - depositTimestamps[msg.sender]) * rewardRatePerSecond);
        ...
        uint256 i = 0;
        for (i=0; i<block.timestamp - depositTimestamps[msg.sender]; i++) {
            indBalanceRewards = (indBalanceRewards * (100 + RewardPercentage)) / 100;
        }
